		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comcnhibtpwarrantyclaimsapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcnhibtpwarrantyclaimsapproval-display": {
								"semanticObject": "comcnhibtpwarrantyclaimsapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"url": sap.ui.require.toUrl("com/cnhi/btp/warrantyclaimsapproval")
								}
							}
						}
					}
